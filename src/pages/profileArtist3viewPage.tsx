...
interface UpgradeAccountConditionInterface {
  viewer: string
  owner: string
}

const UpgradeAccountCondition = ({
  viewer,
  owner,
}: UpgradeAccountConditionInterface) => {
  return <>{viewer === owner ? <UpgradeAccount /> : <></>}</>
}
...
const Profile = () => {
  ...
  return (
    <Stack
      ...
      spacing={2.5}
    >
      {/* <ProfileCondition viewer={currentViewer} owner={currentOwner} /> */}
      <ProfileTitle
        ...
        owner={currentOwner}
      />
      <UpgradeAccountCondition viewer={currentViewer} owner={currentOwner} />
      <ProfileBox />
    </Stack>
  )
}
